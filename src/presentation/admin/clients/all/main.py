...
from presentation.admin.clients.components import ActionsView, ClientCreateModal
...
class ClientListPage(CommonPage):
    ...
    def __init__(self, router: Router):
        ...
        super().__init__(
            ...
            breadcrumbs=[
                ...
                BreadcrumbsConfig("Клиенты", "/clients"),
            ],
        )
    ...
    def __open_create_form(self):
        self.page.show_dialog(ClientCreateModal())
