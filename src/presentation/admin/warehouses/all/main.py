...
from presentation.admin.warehouses.components import ActionsView, WarehouseCreateModal
...
class WarehouseListPage(CommonPage):
    title: str = "Склады"
    topic_name: str = "warehouse_list_page__refetch"
    ...
    def __init__(self, router: Router):
        ...
        super().__init__(
            ...
            breadcrumbs=[
                ...
                BreadcrumbsConfig("Склады", "/warehouses"),
            ],
        )
    ...
    def __open_create_form(self):
        self.page.show_dialog(WarehouseCreateModal())
