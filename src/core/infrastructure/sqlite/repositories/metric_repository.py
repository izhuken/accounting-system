...
from core.infrastructure.sqlite.models import MetricModel
from core.infrastructure.sqlite.repositories.base_repository import BaseRepository


class MetricRepository(BaseRepository, IMetricRepository):
    model = MetricModel
    ...
    async def exists(self, entity: Metric) -> bool:
